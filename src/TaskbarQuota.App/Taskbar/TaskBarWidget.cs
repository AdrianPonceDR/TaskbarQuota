...
namespace TaskbarQuota.Taskbar
{
    ...
    internal sealed class TaskBarWidget : IDisposable
    {
        ...
        public void SetVisible(bool visible)
        {
            ...
            // Do not animate visibility with a XAML Storyboard. A full dump captured after a failed hide
            // showed Application.Start had returned while the 100 ms Storyboard was still pending:
            // Completed never ran, the HWND retained WS_VISIBLE, and H.NotifyIcon kept a zombie process
            // alive. Apply the island opacity and child-window state synchronously at this boundary.
